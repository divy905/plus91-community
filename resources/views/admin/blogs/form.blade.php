                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="meta_title" id="meta_title" onkeyup="get_metatitle_length(this.value)" class="form-control">{{old('meta_title')}}</textarea>
                    ...
                    <div class="col-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="meta_description" id="meta_description" onkeyup="get_metadescription_length(this.value)" class="form-control">{{old('meta_description')}}</textarea>
