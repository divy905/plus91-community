              ...
              <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                ...
                <tbody>
                  <?php if(!empty($blogs)){
                      ...
                      <tr>
                        ...
                        <td>{{$new->title ?? ''}}</td>
                          ...
                          if(!empty($new->image)){
                            ...
                            <td class="text-end">
                              <div class="actions ">
                                <a href="{{ route($routeName.'.blogs.edit', $new->id.'?back_url='.$BackUrl) }}" class="btn btn-sm bg-success-light me-2 ">
                                  <i class="feather-edit"></i>
                                </a>
                                <a href="{{ route($routeName.'.blogs.delete', $new->id.'?back_url='.$BackUrl) }}" onclick="return confirm('Are You Want to Delete This')" class="btn btn-sm bg-danger-light">
                    ...
                    {{ $blogs->appends(request()->input())->links('admin.pagination') }}
