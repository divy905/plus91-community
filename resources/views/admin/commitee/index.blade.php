...
<div class="page-wrapper">
  <div class="content container-fluid">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="page-sub-header">
            <h3 class="page-title">Commitee Management</h3>
            <ul class="breadcrumb">
              <li class="breadcrumb-item active">All Commitee</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <form action="{{ url('admin/commitee') }}" method="get">
          @csrf
          ...
          <div class="card-body">
            <div class="page-header">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="page-title">Commitee</h3>
                </div>
              </div>
            </div>
