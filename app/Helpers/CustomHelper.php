...
public static function getImageUrlNew($path,$filename){
   if(!empty($filename)){
        // $filename = str_replace(' ', '', $filename);
    return 'https://image.cartodayindia.today/'.$path.'/'.$filename;
...
public static function UploadImage($file, $path, $ext='', $width=768, $height=768, $is_thumb=false, $thumb_path, $thumb_width=300, $thumb_height=300,$image_name=''){
